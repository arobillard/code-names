    ...
    return (
      <footer className="footer pad-t-b-2 gutter" role="contentinfo">
        <div className="wrapper">
          <div>
            <small className="block push">Based on popular table top game <a href="https://czechgames.com" target="_blank">Codenames</a> by <a href="https://czechgames.com/en/codenames/" target="_blank">Czech Games</a>.</small>
